...
// Method to convert infix to postfix:
	...
	public String convertToPostfix(String infix)	// Return a postfix representation of the expression in infix.
	{
		Stack operatorStack = new Stack();	// the stack of operators
		char c;		// the first character of a token
		
		StringTokenizer parser = new StringTokenizer(infix,"+-*/^() ",true);	// StringTokenizer for the input string
		...
		while (parser.hasMoreTokens())
		{
			...
			{	// while operator stack is not empty and the 
